...
namespace BudgetCalculator.Controllers
{
    public class HouseholdExpensesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HouseholdExpenseId,RentType,RentAmount,GroceryAmount,ClothingAmount,EducationFeesAmount,SchoolBooksAmount,MedicalBillAmount,HouseholdInsuranceAmount,HouseholdMaintenanceAmount,HouseholdOtherAmount,TotalHouseholdExpenses,BudgetId")] HouseholdExpense householdExpense, int id)
        {
            // foreign key id attribute
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HouseholdExpenseId,RentType,RentAmount,GroceryAmount,ClothingAmount,EducationFeesAmount,SchoolBooksAmount,MedicalBillAmount,HouseholdInsuranceAmount,HouseholdMaintenanceAmount,HouseholdOtherAmount,TotalHouseholdExpenses,BudgetId")] HouseholdExpense householdExpense)
        {
            if (ModelState.IsValid)
            {
